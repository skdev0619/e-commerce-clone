...
interface ProductApiSpecification {
    ...
    fun product(@Parameter(description = "조회할 상품 ID", example = "1") id: Long): ResponseEntity<ProductViewResponse>

    @Operation(summary = "모든 상품 정보 조회", description = "모든 상품들의 정보를 조회한다")
    @ApiResponses(
        value = [
            ApiResponse(
                responseCode = "200",
    ...
    fun allProduct(): ResponseEntity<List<ProductViewResponse>>
}
